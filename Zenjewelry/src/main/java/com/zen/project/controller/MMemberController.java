...
public class MMemberController {
	...
	private static final Logger logger = LoggerFactory.getLogger(MMemberController.class);
	
	@Autowired
	MemberService ms;
	
	@RequestMapping(value="/mloginForm")
	...
	public String login( @ModelAttribute("dto") @Valid MemberVO membervo,
		...
		if( result.getFieldError("id") != null ) {
			...
			if(mvo.get("PWD")==null) {
				...
				model.addAttribute("message" , "블랙리스트 회원입니다 관리자에게 문의하세요 Zenjewelry@naver.com");
				return "mobile/member/login";
			}else if(mvo.get("USEYN").equals("일시정지")) {
				model.addAttribute("message" , "일시정지 회원입니다 관리자에게 문의하세요 Zenjewelry@naver.com");
				return "mobile/member/login";
			}else if(mvo.get("USEYN").equals("휴면")) {
				model.addAttribute("message" , "휴면계정 입니다 관리자에게 문의하세요 Zenjewelry@naver.com");
				return "mobile/member/Break";
	...
	@RequestMapping(value="/mcontract")
	...
	@RequestMapping(value="/mfindZipNum")
	public String find_zip( HttpServletRequest request , Model model) {
		...
		return "mobile/member/findZipNum";
	}
	...
	@RequestMapping(value = "/meditForm")
	...
	@RequestMapping(value = "/mmemberUpdate", method=RequestMethod.POST)
	...
	@RequestMapping(value="/mfindAccount")
	public String findAccount() {
		return "mobile/member/findAccount";
	}
	
	@RequestMapping(value="/mfindIdForm")
	public String findIdForm() {
		return "mobile/member/findIdForm";
	}
	
	@RequestMapping(value="/mfindIdStep1" , method=RequestMethod.POST)
	...
	public String ID(@RequestParam("email") String email, 
		...
		return "mobile/member/ID";
	}
	
	@RequestMapping(value="/mfindPwForm")
	public String findPwForm() {
		return "mobile/member/findPwForm";
	}
	
	@RequestMapping(value="/mfindPwStep1")
	public String findPwStep1( @RequestParam("email") String email, 
        ...
        return "/mobile/findPwForm";	}	
    }
	

	@RequestMapping(value="/mchange_Pwd" ,method=RequestMethod.POST)
	...
	@RequestMapping("/mEmailCheckForm")
	public String EmailCheckForm( @RequestParam("email") String email,
			Model model, HttpServletRequest request ) {
		...
		model.addAttribute("email", email);
		return "mobile/member/emailCheck";
	}
	
	
@RequestMapping(value="/mnumCkeck")
	
	public String numCkeck( @RequestParam("email") String email, 
			Model model
			)  throws Exception{
        ...
        return "mobile/member/numCkeck";	
        }

@RequestMapping(value = "/mSwitch_dormant_account")
