...
<article>
	<form method="post" name="updateDelivery">
		<fieldset class="input-box">
			...
			<label>주소</label><input type="text" name="addr1"   size="50" value="${orderList.ADDRESS}"><br>
			<label>상세주소</label><input type="text" name="addr2"   size="50" value="${orderList.ADDRESS2}"><br>
</fieldset>
<div class="clear"></div>
<div id="buttons">
